...
For detailed usage instructions, see the [GithubLinkAdmonition.md](./GithubLinkAdmonition.md) file.
...
<GithubLinkAdmonition link="https://www.example.com" text="Check out this awesome resource!" />
